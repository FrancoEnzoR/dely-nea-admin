...
function Sidebar() {
  ...
  return (
    <div style={{
      width: 240, minHeight: '100vh', backgroundColor: C.card,
              ...
              <div style={{
                ...
                {active && (
                  <div style={{
                    ...
                    borderRadius: '50%', backgroundColor: C.violet,
                  }} />
                )}
              </div>
            </Link>
      ...
      <div style={{ padding: 16 }}>
        <div style={{
          backgroundColor: C.cardLight, borderRadius: 10, padding: '10px 12px',
...
function TopBar() {
  ...
  return (
    <div style={{
      ...
      backgroundColor: `${C.base}EE`, backdropFilter: 'blur(12px)',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{
          fontSize: 11, color: C.muted, backgroundColor: C.cardLight,
          border: `1px solid ${C.border}`, borderRadius: 8, padding: '4px 12px',
        }}>Gran Resistencia</div>
      </div>
    </div>
  );
}
